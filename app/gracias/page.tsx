      ...
      <main>
        <div className="min-h-screen flex flex-col justify-center items-center" style={{ paddingTop: "8rem", paddingBottom: "6rem" }}>
          <div className="max-w-lg mx-auto px-6 md:px-10 text-center animate-fade-up">
            ...
            <p style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "1.1rem", fontStyle: "italic", color: "#4F5B4A", lineHeight: "1.7", marginBottom: "3rem" }}>Enquanto aguarda: verifique a sua caixa de entrada.<br />Às vezes chegamos ao spam — corrija isso, se acontecer.</p>
            <div style={{ backgroundColor: "rgba(79,91,74,0.06)", border: "1px solid rgba(79,91,74,0.15)", padding: "1.75rem 2rem", marginBottom: "3rem" }}>
              <p style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "1.1rem", fontStyle: "italic", color: "#2C2926", lineHeight: "1.65" }}>&ldquo;O Almanaque não existe para lhe dar mais coisas a fazer. Existe para ajudá-lo a ver melhor o que já está a fazer.&rdquo;</p>
            </div>
