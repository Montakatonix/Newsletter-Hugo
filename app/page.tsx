...
ribarse" className="btn-animated anim-pulse-soft" style={{ display: "inline-block", padding: "0.95rem 2.5rem", backgroundColor: "#F3EFE6", color: "#2C2926", fontFamily: "var(--font-jost)", fontSize: "0.75rem", letterSpacing: "0.18em", textTransform: "uppercase", fontWeight: 500, textDecoration: "none" }}>{t("cta.btn")}</Link>
