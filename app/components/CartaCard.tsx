...
export default function CartaCard({ carta, variant = "list" }: CartaCardProps) {
  if (variant === "featured") {
    return (
      ...
      >
        <article className="group" style={{ padding: "2.5rem", backgroundColor: "rgba(44,41,38,0.03)", border: "1px solid rgba(44,41,38,0.1)" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-cormorant)", fontSize: "1.75rem", fontWeight: 500, color: "#2C2926", lineHeight: 1.2, marginBottom: "0.75rem" }}>{arta.titulo}</h2>
