    ...
    return (
      <Link href={`/arquivo/${carta.slug}`} style={{ textDecoration: "none", display: "block" }}>
        <article className="group" style={{ padding: "2.5rem", backgroundColor: "rgba(44,41,38,0.03)", border: "1px solid rgba(44,41,38,0.1)", transition: "border-color 0.3s, background-color 0.3s" }}
          onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(79,91,74,0.4)"; (e.currentTarget as HTMLElement).style.backgroundColor = "rgba(79,91,74,0.04)"; }}
          onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(44,41,38,0.1)"; (e.currentTarget as HTMLElement).style.backgroundColor = "rgba(44,41,38,0.03)"; }}>
          ...
          <div className="flex items-center gap-2 mt-5" style={{ color: "#4F5B4A" }}>
            ...
            <span className="group-hover:translate-x-1 inline-block" style={{ fontSize: "0.7rem", transition: "transform 0.25s" }}>→</span>
          </div>
        </article>
      </Link>
    );
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              {carta.simbolo && <span style={{ color: "#4F5B4A", opacity: 0.5, fontSize: "0.7rem" }}>🜂</span>}
            </div>
          ...
          <span className="group-hover:translate-x-1 inline-block" style={{ color: "#4F5B4A", fontSize: "0.9rem", flexShrink: 0, marginTop: "0.25rem", transition: "transform 0.25s" }}>→</span>
        </div>
      </article>
    </Link>
  );
