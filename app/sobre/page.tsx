...
export const metadata: Metadata = {
  title: "Sobre",
  description:
    "O que é o Almanaque Contemporâneo, para quem existe e por que existe.",
};
      ...
      <main>
        <div className="max-w-5xl mx-auto px-6 md:px-10" style={{ paddingTop: "9rem", paddingBottom: "6rem" }}>
          <div className="mb-16">
            ...
            <h1 style={{ fontFamily: "var(--font-cormorant)", fontSize: "clamp(2.5rem, 5vw, 4.5rem)", fontWeight: 400, lineHeight: 1.0, color: "#2C2926", letterSpacing: "-0.02em" }}>Almanaque<br /><span style={{ fontStyle: "italic", fontWeight: 300 }}>Contemporâneo</span></h1>
          </div>
          <div className="grid md:grid-cols-12 gap-16">
            ...
            <div className="md:col-span-7">
              <div className="prose-editorial">
                ...
                <h2>O q1e não é</h2>
                <p>Não é coaching. Não é produtividade com outro nome. Não é autoajuda embalada em linguagem filosófica. É uma carta. Escrita para ser lida com calma, uma vez por semana, sem pressa.</p>
            ...
            <div className="md:col-span-5">
              <div style={{ position: "sticky", top: "8rem" }}>
                {[{ label: "Frequência", value: "Uma carta por semana", detail: "Às quartas-feiras" }, { label: "Duração", value: "5 a 10 minutos", detail: "Por edição" }, { label: "Formato", value: "Carta editorial", detail: "Texto longo, sem imagens" }, { label: "Custo", value: "Gratuito", detail: "Sem publicidade" }, { label: "Cancelamento", value: "Quando quiser", detail: "Sem fricção" }].map((item, i) => (
                  <div key={i} style={{ backgroundColor: "rgba(44,41,38,0.03)", border: "1px solid rgba(44,41,38,0.08)", padding: "1.1rem 1.4rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem", marginBottom: "2px" }}>
                    <div>
                ...
                <div style={{ marginTop: "1.5rem", padding: "1.75rem", backgroundColor: "rgba(79,91,74,0.07)", border: "1px solid rgba(79,91,74,0.15)" }}>
                  <p style={{ fontFamily: "var(--font-cormorant)", fontSize: "1.1rem", fontStyle: "italic", color: "#2C2926", lineHeight: "1.65" }}>&ldquo;Entra, pousa, respira, lê melhor.&rdquo;</p>
                </div>
              </div>
            </div>
          </div>
