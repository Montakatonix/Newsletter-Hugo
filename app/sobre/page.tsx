...
export const metadata: Metadata = {
  title: "Sobre",
  description: "O que é o Almanaque Contemporâneo, para quem existe e por que existe.",
};
          ...
          <div className="grid md:grid-cols-12 gap-16">
            <div className="md:col-span-7 animate-fade-up delay-200">
              <div className="prose-editorial">
                ...
                <h2>O que não é</h2>
                <p>Não é coaching. Não é produtividade com outro nome. Não é autoajuda embalada em linguagem filosófica. Não é motivação. Não é uma lista de hábitos. Não é conteúdo para partilhar nas redes sociais.</p>
                <p>É uma carta. Escrita para ser lida com calma, uma vez por semana, sem pressa.</p>
                <h2>Para quem existe</h2>
                <p>Para quem prefere pensar a reagir. Para quem sente que a maior parte do ruído não tem resposta — tem apenas melhor distância. Para quem quer cultivar uma forma mais cuidada de ler a experiência.</p>
                <p>Não é necessário ter formação em filosofia. É necessário ter paciência para uma leitura de sete minutos.</p>
                <h2>Por que existe</h2>
                <p>Porque a maioria dos conteúdos sobre pensamento é, na prática, sobre velocidade: mais rápido, mais produtivo, mais optimizado. O Almanaque vai na direcção contrária. Mais lento. Mais fundo. Mais útil, por isso.</p>
                <p>Porque há perguntas que só se respondem quando paramos de as evitar. E a maior parte de nós está demasiado ocupado a evitá-las.</p>
                <h2>O que pode esperar</h2>
                <p>Uma carta por semana, às quartas-feiras. Entre cinco e dez minutos de leitura. Um tema, uma observação, uma forma diferente de ver. Nada mais. Nada menos.</p>
              </div>
              <div className="mt-12">
            ...
            <div className="md:col-span-5 animate-fade-up delay-300">
              <div style={{ position: "sticky", top: "8rem", display: "flex", flexDirection: "column", gap: "2px" }}>
                {[
                  { label: "Frequência", value: "Uma carta por semana", detail: "Às quartas-feiras" },
                  { label: "Duração", value: "5 a 10 minutos", detail: "Por edição" },
                  { label: "Formato", value: "Carta editorial", detail: "Texto longo, sem imagens" },
                  { label: "Custo", value: "Gratuito", detail: "Sem publicidade" },
                  { label: "Cancelamento", value: "Quando quiser", detail: "Sem fricção" },
                ].map((item, i) => (
