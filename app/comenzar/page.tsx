...
export const metadata: Metadata = { title: "Começar por aqui", description: "Orientação para novos leitores do Almanaque Contemporâneo. Por onde começar." };
          ...
          <div className="animate-fade-up delay-200 mb-20" style={{ borderTop: "1px solid rgba(44,41,38,0.1)", borderBottom: "1px solid rgba(44,41,38,0.1)", backgroundColor: "rgba(79,91,74,0.04)", padding: "3rem 0" }}>
            <div style={{ maxWidth: "680px" }}>
              ...
              <div className="flex flex-col gap-6">
                {[{num:"01",titulo:"Uma carta por semana",texto:"Às quartas-feiras, uma nova carta chega à sua caixa de entrada. Entre cinco e dez minutos de leitura."},{num:"02",titulo:"Um tema, uma perspectiva",texto:"Cada carta parte de um padrão humano concreto e oferece uma forma diferente de o ver. Sem fórmulas."},{num:"03",titulo:"O arquivo fica aqui",texto:"Todas as cartas anteriores estão disponíveis no arquivo. Pode ler na ordem que quiser."}].map((item) => (
                  <div key={item.num} className="flex items-start gap-5">
                    <span style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "1.5rem", fontWeight: 300, color: "#4F5B4A", opacity: 0.5, flexShrink: 0, lineHeight: 1, marginTop: "0.1rem" }}>{item.num}</span>
                    <div>
