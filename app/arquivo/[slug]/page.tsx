        ...
        <article>
          ...
          <div className="max-w-5xl mx-auto px-6 md:px-10" style={{ paddingTop: "9rem", paddingBottom: "4rem" }}>
            <div style={{ maxWidth: "680px", margin: "0 auto" }}>
              <div className="flex items-center gap-3 mb-8" style={{ flexWrap: "wrap" }}>
                ...
                <span style={{ color: "rgba(44,41,38,0.3)" }}>/</span>
                <span style={{ fontFamily: "var(--font-jost)", fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#4A433D", opacity: 0.5, fontWeight: 300 }}>N�:{String(carta.numero).padStart(2, "0")}</span>
              </div>
          ...
          <div className="max-w-5xl mx-auto px-6 md:px-10" style={{ paddingBottom: "4rem" }}>
            <div style={{ maxWidth: "680px", margin: "0 auto", borderTop: "1px solid rgba(44,41,38,0.1)", paddingTop: "2.5rem" }}>
              <p style={{ fontFamily: "var(--font-cormorant)", fontSize: "0.9rem", fontStyle: "italic", color: "#4A433D", textAlign: "center", marginTop: "1.5rem", opacity: 0.7 }}>Almanaque Contemporâneo</p>
            </div>
          </div>
          {/* Navegação */}
          {(anterior || seguinte) && (
