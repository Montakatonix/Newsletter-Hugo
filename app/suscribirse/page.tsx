          ...
          <div className="max-w-5xl mx-auto px-6 md:px-10 w-full">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "1rem", fontStyle: "italic", color: "#4F5B4A", marginTop: "2rem", paddingTop: "1.5rem", borderTop: "1px solid rgba(44,41,38,0.1)" }}>&ldquo;Entra, pousa, respira, lê melhor.&rdquo;</p>
              </div>
            </div>
          </div>
        </div>
